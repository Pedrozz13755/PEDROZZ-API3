...
router.all('/wallpapernime', async (req, res) => {
 const { username, key } = req.query;
  ...
  const add = adicionarSaldo(username)
   ...
   json = JSON.parse(fs.readFileSync('data/wallpapernime.json').toString())
 ...
 const { username, key } = req.query;
  ...
  const add = adicionarSaldo(username)
   ...
   json = JSON.parse(fs.readFileSync('data/satanic.json').toString())
   random = json[Math.floor(Math.random() * json.length)]
   res.type('png')
   res.send(await getBuffer(random))
    } else {
 ...
 const { username, key } = req.query;
  ...
  const add = adicionarSaldo(username)
   ...
   json = JSON.parse(fs.readFileSync('data/bonek.json').toString())
   random = json[Math.floor(Math.random() * json.length)]
   res.type('png')
   res.send(await getBuffer(random))
     } else {
 ...
 const { username, key } = req.query;
  ...
  const add = adicionarSaldo(username)
   ...
   json = JSON.parse(fs.readFileSync('data/travazap.json').toString())
   random = json[Math.floor(Math.random() * json.length)]
   res.type('png')
   res.send(await getBuffer(random))
    } else {
...
const { username, key } = req.query;
  ...
  const add = adicionarSaldo(username)
   ...
   json = JSON.parse(fs.readFileSync('data/femininotrava.json').toString())
   random = json[Math.floor(Math.random() * json.length)]
   res.type('png')
   res.send(await getBuffer(random))
       } else {
